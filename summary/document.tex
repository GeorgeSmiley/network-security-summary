...
\begin{document}
	...
	\section{Wireless security}
		\subsection{Panoramica}
			...
			Spostando il focus su reti wireless si ricorda che un \textbf{hotspot} è un punto di accesso alla rete attraverso tecnologia wireless (802.11) in modalità infrastructure. La tecnologia wireless ha il \textbf{vantaggio} di abbattere i costi di gestione, poichè \textbf{non si deve cablare} tutti gli host della rete. Introducono tuttavia diverse \textbf{problematiche di gestione} come la \textbf{limitazione del raggio e la gestione degli accessi}.\\
		...
		\subsection{802.11: Wifi}
			...
			\subsubsection{WEP: Autenticazione Shared Key}
				...
				\textit{Stream  \ref{fig:52}}\\
				\begin{figure}[h!]
					\centering
					\includegraphics[scale=0.50]{img/stream.PNG}
					\caption{Stream\label{fig:52}}
				\end{figure}\\
				...
				\begin{figure}[h!]
					\centering
					\includegraphics[scale=0.50]{img/enrsa.PNG}
			...
			\subsubsection{WEP: Uscita dalla rete}
				...
				\textit{Macchina a stati 802.11 \ref{fig:54}}\\
				\begin{figure}[h!]
					\centering
					\includegraphics[scale=0.50]{img/statemach.PNG}
					\caption{Macchina a stati 802.11\label{fig:54}}
				\end{figure}\\
		...
		\subsection{Insicurezze di 802.11}
			Le insicurezze che vedremo riguardano le versioni \textbf{a, b, g}, alcune di queste non riguardano gli algoritmi crittografici utilizzati quindi vengono ritrovati anche nella versione \textbf{i}. 
